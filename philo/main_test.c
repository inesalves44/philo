...
/*   Updated: 2023/05/31 15:10:10 by idias-al         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*hello_thread(void	*test1)
{
	...
	while (i <= 5)
	{
		...
		printf("Hello from thread philo %d\n", philo->i);
...
void	lets_eat(t_philo philo)
{
	...
	while (i < philo.n_philo)
	{
		...
		pthread_mutex_init(&philo.test[i].left, NULL);
	...
	while (i < philo.n_philo)
	{
		...
		pthread_mutex_destroy(&philo.test->left);
		i++;
	}
